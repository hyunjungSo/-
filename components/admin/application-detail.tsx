                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3" colSpan={3}>
                        <div className="flex flex-wrap gap-2">
                          ...
                          >
                            <span className="truncate max-w-[180px] text-xs text-foreground">토지대장_용인시_포곡읍_200-1.pdf</span>
                          ...
                          <button
                            ...
                            className="flex items-center gap-2 rounded-md border border-gray-200 bg-white px-3 py-2 cursor-pointer hover:bg-gray-50 transition-colors"
                          >
                            <span className="truncate max-w-[180px] text-xs text-foreground">지적도_용인시_포곡읍_200-1.pdf</span>
                            <Eye className="size-[14px] shrink-0 text-muted-foreground" />
                          </button>
                          <button
                            ...
                            className="flex items-center gap-2 rounded-md border border-gray-200 bg-white px-3 py-2 cursor-pointer hover:bg-gray-50 transition-colors"
                          >
                            <span className="truncate max-w-[180px] text-xs text-foreground">현장사진_20260501.jpg</span>
                            <Eye className="size-[14px] shrink-0 text-muted-foreground" />
                          </button>
                        </div>
                      </td>
