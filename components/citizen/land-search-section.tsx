...
const regionData = {
  ...
  읍면동: {
    ...
    // 제주특별자치도
    "제주시": ["구좌읍", "애월읍", "우도면", "조천읍", "추자면", "한경면", "한림읍", "아라동", "건입동", "노형동", "봉개동", "삼도동", "연동", "오라동", "외도동", "용담동", "이도동", "이호동", "일도동", "화���동"],
  ...
  리: {
    ...
    "장호원읍": ["나래리", "노탑리", "선읍리", "송산리", "와현리", "장왕리", "����리", "풍계리"],
    "율면": ["���당리", "반���리", "����������리", "월포���", "이황리"],
    ...
    "감곡면": ["단평리", "문촌리", "사곡리", "상우리", "��궁리", "오향리", "영산리"],
    // 충청북도 - 진천군
