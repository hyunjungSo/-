    ...
    <div className="space-y-6">
      ...
      {cartItems.length > 0 && !isCartOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 flex h-14 animate-pulse items-center gap-2 rounded-full bg-primary px-5 text-white shadow-lg transition-all hover:animate-none hover:bg-primary/90 hover:shadow-xl"
        >
