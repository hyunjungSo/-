...
const regionData = {
  ...
  리: {
    ...
    "감곡면": ["단평리", "문촌리", "사곡리", "상우리", "오궁리", "오향리", "영산리"],
    // 충청북도 - 진천군
        ...
        const ownerLandData = [
          // 양평이천 관할기관 - 2건
          {
            ...
            coordinates: [
              ...
              { lat: 37.2354, lng: 127.3808 },
              { lat: 37.2358, lng: 127.3815 },
              { lat: 37.2355, lng: 127.3822 },
              { lat: 37.2348, lng: 127.3818 },
              { lat: 37.2345, lng: 127.3807 },
            ],
            originalArea: 850,
          ...
          },
          {
            ...
            coordinates: [
              ...
              { lat: 37.4856, lng: 127.5322 },
              { lat: 37.4858, lng: 127.5330 },
              { lat: 37.4855, lng: 127.5338 },
              { lat: 37.4848, lng: 127.5340 },
              { lat: 37.4845, lng: 127.5332 },
              { lat: 37.4847, lng: 127.5325 },
            ],
            originalArea: 1120,
          ...
          // 부산울산 관할기관 - 2건
          {
            ...
            coordinates: [
              ...
              { lat: 35.1628, lng: 129.1636 },
              { lat: 35.1630, lng: 129.1648 },
              { lat: 35.1622, lng: 129.1652 },
              { lat: 35.1618, lng: 129.1642 },
            ],
            originalArea: 980,
          ...
          },
          {
            ...
            coordinates: [
              ...
              { lat: 35.5432, lng: 129.2638 },
              { lat: 35.5435, lng: 129.2655 },
              { lat: 35.5425, lng: 129.2658 },
              { lat: 35.5418, lng: 129.2648 },
            ],
            originalArea: 1350,
          ...
          // 강진광주 관할기관 - 1건
          {
            ...
            coordinates: [
              ...
              { lat: 35.1326, lng: 126.7918 },
              { lat: 35.1330, lng: 126.7928 },
              { lat: 35.1328, lng: 126.7938 },
              { lat: 35.1320, lng: 126.7940 },
              { lat: 35.1316, lng: 126.7930 },
            ],
            originalArea: 780,
          ...
          // 춘천원주 관할기관 - 1건
          {
            ...
            coordinates: [
              ...
              { lat: 37.8525, lng: 127.6838 },
              { lat: 37.8530, lng: 127.6845 },
              { lat: 37.8528, lng: 127.6855 },
              { lat: 37.8522, lng: 127.6860 },
              { lat: 37.8515, lng: 127.6855 },
              { lat: 37.8512, lng: 127.6845 },
              { lat: 37.8516, lng: 127.6838 },
            ],
            originalArea: 1650,
      ...
      if (results.length === 0) {
        const baseCoords = [
          ...
          [
            ...
            { lat: 37.2186, lng: 127.2955 },
            { lat: 37.2188, lng: 127.2965 },
            { lat: 37.2180, lng: 127.2970 },
            { lat: 37.2173, lng: 127.2958 },
          ],
          // 길쭉한 밭 형태 (6각형)
          [
            { lat: 37.2185, lng: 127.2960 },
            { lat: 37.2190, lng: 127.2962 },
            { lat: 37.2195, lng: 127.2975 },
            { lat: 37.2192, lng: 127.2985 },
            { lat: 37.2183, lng: 127.2980 },
            { lat: 37.2180, lng: 127.2968 },
          ],
          // 삼각형에 가까운 형태 (5각형)
          [
            { lat: 37.2192, lng: 127.2972 },
            { lat: 37.2202, lng: 127.2978 },
            { lat: 37.2205, lng: 127.2992 },
            { lat: 37.2195, lng: 127.2998 },
            { lat: 37.2188, lng: 127.2982 },
          ],
          // T자형 필지 (7각형)
          [
            { lat: 37.2170, lng: 127.2940 },
            { lat: 37.2178, lng: 127.2942 },
            { lat: 37.2180, lng: 127.2950 },
            { lat: 37.2176, lng: 127.2958 },
            { lat: 37.2168, lng: 127.2960 },
            { lat: 37.2164, lng: 127.2952 },
            { lat: 37.2166, lng: 127.2944 },
          ],
          // 대지 형태 (6각형)
          [
            { lat: 37.2200, lng: 127.2985 },
            { lat: 37.2207, lng: 127.2988 },
            { lat: 37.2210, lng: 127.2998 },
            { lat: 37.2206, lng: 127.3008 },
            { lat: 37.2198, lng: 127.3005 },
            { lat: 37.2196, lng: 127.2992 },
          ],
        ];
