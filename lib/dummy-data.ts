...
export const preRegisteredParcels: PreRegisteredParcel[] = [
  {
    ...
    aiResult: {
      ...
      farmMachineDifficulty: true,
      judgmentRationale: {
        summary: "농지 잔여지 - 면적, 형상, 농기계 회전 곤란 기준 충족으로 「매수 신청 가능」 판정",
  ...
  },
  {
    ...
    aiResult: {
      ...
      farmMachineDifficulty: true,
      judgmentRationale: {
        summary: "농지 잔여지 - 형상 변화, 농기계 진입불가, 관개수로 상실로 「매수 신청 가능」 판정",
        legalBasis: "「공익사업을 위한 토지 등의 취득 및 보상에 관한 법률」 제74조",
  ...
  },
  {
    ...
    aiResult: {
      ...
      farmMachineDifficulty: true,
      judgmentRationale: {
        summary: "농지 잔여지 - 형상 변화 및 농기계 진입불가로 「매수 신청 가능」 판정",
        legalBasis: "「공익사업을 위한 토지 등의 취득 및 보상에 관한 법률」 제74조",
  ...
  // 신청불가 케이스 1 - 면적 기준 미달
  {
    ...
    aiResult: {
      ...
      farmMachineDifficulty: false,
      judgmentRationale: {
        summary: "농지 잔여지 - 면적, 형상, 형상지수 모든 기준 미충족으로 「매수 신청 불가」 판정",
        legalBasis: "「공익사업을 위한 토지 등의 취득 및 보상에 관한 법률」 제74조",
  ...
  // 신청불가 케이스 2 - 맹지 미해당
  {
    ...
    aiResult: {
      ...
      farmMachineDifficulty: false,
      judgmentRationale: {
        summary: "대지 잔여지 - 면적 초과, 맹지 미해당, 건축 가능으로 「매수 신청 불가」 판정",
        legalBasis: "「공익사업을 위한 토지 등의 취득 및 보상에 관한 법률」 제74조",
...
export const dummyApplications: Application[] = [
  ...
  // 대리인 신청 케이스
  {
    ...
    agentContact: "010-9999-8888", // 대리��� 연락처
  ...
  },
  {
    ...
    reportedShape: "자루형",
    farmMachineDifficulty: false,
    reason: "산지가 자루형으로 변형되��� 임도 접근이 불가능해졌습니다. 종래 목적으로 사용이 현저히 곤란합니다.",
  ...
  // 검토필요 케이스 - 실측 및 추가 검토 필요
  {
    ...
    aiResult: {
      landTypePath: "택지",
      criteriaChecks: [
        { criteriaName: "면적 기준", criteriaDescription: "택지(주거) 기��� 90㎡ 이하 (완화: 135㎡)", isMet: true, autoDetected: true },
  ...
  // 복수필지 케이스 1: 박일단 - 3필지 농지 (AI 분석 완료, 매수 판정)
  {
    ...
    applicantAddress: "경기도 안성시 미양면 계���리 500",
  ...
  // 소규모 복수필지 케이스 2: 이산림 - 5필지 산지 (조��지 분단으로 매수 인정)
  {
  ...
  // 만호리 55-1, 55-2: 전(밭), 면적 기준 미충족 → 미해당
  {
    ...
    aiResult: {
      ...
      criteriaChecks: [
        ...
        { criteriaName: "면적 기준 (200-2)", criteriaDescription: "잔여 180㎡ ≤ 330㎡ (��지 기준 충족)", isMet: true, autoDetected: true },
