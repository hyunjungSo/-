  ...
  // 일단지 신청 -> 담당자 재분석으로 복수필지로 변경된 케이스
  {
    ...
    aiResult: {
      ...
      landJudgments: [
        ...
        { landId: "land-unified-002", judgment: "매수", reason: "대지: 잔여 150㎡(소규모), 형상지수 3.2(불량), 건축 곤란" },
      ],
    },
    // 담당자 AI 재분석 결과 - 개별 필지 판정
    adminAiResult: {
      provisionalJudgment: "매수",
      confidence: 75,
      originalArea: 830,
      ...
      farmMachineDifficulty: false,
      judgmentRationale: {
        summary: "대지 잔여면적 180㎡(소규모 기준 충족), 형상지수 3.2(불량)로 매수 기준 충족",
        legalBasis: "「공익사업을 위한 토지 등의 취득 및 보상에 관한 법률」 제74조 및 동법 시행규칙 제34조",
        appliedCriteria: [
          "토지유형: 대지 (택지)",
      ...
      landJudgments: [
        { landId: "land-unified-001", judgment: "매수", reason: "대지: 잔여 180㎡(소규모), 형상지수 3.2(불량), 건축 곤란" },
        { landId: "land-unified-002", judgment: "미해당", reason: "대지: 잔여 150㎡(소규모)이나 형상지수 2.5(양호), 건축 가능" },
      ],
    },
    adminName: "김철수",
