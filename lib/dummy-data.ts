...
export const dummyApplications: Application[] = [
  ...
  // 접수완료 상태의 3필지 신청 건
  {
    ...
    aiResult: {
      ...
      landJudgments: [
        { landId: "land-3parcel-001", judgment: "조건부매수", reason: "택지: 잔여면적 270㎡, 형상 양호하나 면적 기준 초과로 현장 확인 필요" },
        { landId: "land-3parcel-002", judgment: "조건부매수", reason: "택지: 잔여면적 230㎡, 장방형으로 면적 기준 초과, 건축 가능 여부 확인 필요" },
        { landId: "land-3parcel-003", judgment: "매수가능", reason: "택지: 잔여면적 300㎡이나 사다리꼴 형상으로 건축 효율 저하" },
      ],
    },
    landAIResults: {
      "land-3parcel-001": {
        provisionalJudgment: "조건부매수",
        confidence: 75,
        originalArea: 450,
        remainingArea: 270,
        remainingRatio: 60,
        judgmentRationale: {
          summary: "매탄동 100번지: 잔여면적 270㎡로 기준 초과, 현장 확인 필요",
          legalBasis: "「공익사업법」 제74조",
          appliedCriteria: ["잔여면적 270㎡ > 기준 90㎡"],
          detailedExplanation: "잔여 면적이 주거용 택지 기준을 초과하여 조건부 매수로 판정합니다.",
      ...
      "land-3parcel-002": {
        ...
        remainingRatio: 60.5,
        judgmentRationale: {
          summary: "매탄동 101번지: 잔여면적 230㎡로 기준 초과, 건축 효율 확인 필요",
          legalBasis: "「공익사업법」 제74조",
          appliedCriteria: ["잔여면적 230㎡ > 기준 90㎡", "장방형 형상"],
          detailedExplanation: "장방형 형상으로 건축 효율이 저하될 수 있어 조건부 매수로 판정합니다.",
